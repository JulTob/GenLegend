...
| Q-0035 | The shared core: should the Character hold one grant ledger (Entries and Chips) beside the Dice, with sections built by layouts in the visual package? Is "tags = flags + chips + entries" the algebra? (QST-0020, QST-0016) | Julio, in chat 2026-09-23 | Agent panel stood in (six readers, three designs, three judges); Agora on request | `Dialogs/0026-the-shared-core-one-ledger-many-layouts.md` | 🔵 R1, R2, R3, R5 decided by Julio 2026-09-24 (Decree 0009) · R4, R6 open |
